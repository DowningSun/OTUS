...
Адрес усправления устройства будет состоять из борядкового номера устройства  во всех октетах (в случае пересечения с существующей сетью первый октет будет понижен )

В Триаде, Киторне, Ламасе, Лабытнагах и Чокудах в 3 октет добавлено число 100, что бы небыло пересечения с подсетями назначеными на интерфейсах маршрутизаторов этих городов.
