...
**acces-list staSALES_RULES размещается на порте 10.40.0.1 IN**
**deny tcp 10.40.0.0 0.0.0.255 10.20.0.0 0.0.0.255 eq 443**
**deny tcp 10.40.0.0 0.0.0.255 10.20.0.1 0.0.0.255 eq 443**
**deny tcp 10.40.0.0 0.0.0.255 10.30.0.1 0.0.0.255 eq 443**
**deny tcp 10.40.0.0 0.0.0.255 10.40.0.1 0.0.0.255 eq 443**
**deny tcp 10.40.0.0 0.0.0.255 10.20.0.1 0.0.0.255 eq 80**
**deny tcp 10.40.0.0 0.0.0.255 10.30.0.1 0.0.0.255 eq 80**
**deny tcp 10.40.0.0 0.0.0.255 10.40.0.1 0.0.0.255 eq 80**
**permit ip any any**
...
**acces-list OPERATORS_RULES размещается на порте 10.30.0.1 In**
