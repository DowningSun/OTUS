...
**Вопрос:** Удалось ли вам установить SSH-соединение с коммутатором? **Да**
...
Какие версии протокола SSH поддерживаются при использовании интерфейса командной строки? **По-умолчанию используется SSHv1 (1.99), также можно активировать SSHv2 командо ip ssh v 2**
...
**Саздать несколько пользователей**
